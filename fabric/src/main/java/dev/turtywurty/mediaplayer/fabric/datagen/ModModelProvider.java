...
import dev.turtywurty.mediaplayer.block.GlobeBlock;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockModelGenerators) {
        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(
                ...
                new MultiVariant(WeightedList.of(new Variant(MediaPlayer.id("block/radio")))))
        ...
        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(
                ...
                new MultiVariant(WeightedList.of(new Variant(MediaPlayer.id("block/globe")))))
        ...
        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(
                ...
                new MultiVariant(WeightedList.of(new Variant(MediaPlayer.id("block/speaker")))))
    ...
    private static void speakerBlockState(BlockModelGenerators blockModelGenerators, Block block,
        ...
        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(
                block,
                new MultiVariant(WeightedList.of(new Variant(MediaPlayer.id("block/" + modelName)))))
                .with(PropertyDispatch.modify(SpeakerBlock.FACING)
                        .select(HorizontalDirection8.NORTH, NOP)
                        .select(HorizontalDirection8.NORTH_EAST, Y_ROT_90)
                        .select(HorizontalDirection8.EAST, Y_ROT_90)
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerators) {
        itemModelGenerators.itemModelOutput.accept(
                ...
                ItemModelUtils.plainModel(MediaPlayer.id("block/radio")));

        itemModelGenerators.itemModelOutput.accept(
                ModBlocks.globe.asBlock().asItem(),
                ItemModelUtils.plainModel(MediaPlayer.id("block/globe")));

        itemModelGenerators.itemModelOutput.accept(
                ModBlocks.speaker.asBlock().asItem(),
                ItemModelUtils.plainModel(MediaPlayer.id("block/speaker")));
    ...
    private static void speakerItemModel(ItemModelGenerators itemModelGenerators, Item item,
        ...
        itemModelGenerators.itemModelOutput.accept(
                item,
                ItemModelUtils.plainModel(MediaPlayer.id("block/" + modelName)));
    }
}

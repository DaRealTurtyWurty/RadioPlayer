...
public class ModEnglishLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.@NonNull Provider registryLookup, @NonNull TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("mediaplayer.configuration.title", "Media Player Configuration");
        translationBuilder.add("mediaplayer.configuration", "General");
        translationBuilder.add("mediaplayer.configuration.ffmpegExecutablePath", "FFmpeg Executable Path");
        translationBuilder.add("mediaplayer.configuration.ffmpegExecutablePath.tooltip",

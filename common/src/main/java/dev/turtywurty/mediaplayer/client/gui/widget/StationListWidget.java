package dev.turtywurty.mediaplayer.client.gui.widget;

import dev.turtywurty.mediaplayer.MediaPlayer;
import dev.turtywurty.mediaplayer.api.client.GlobePoint;
import dev.turtywurty.mediaplayer.client.RadioStationPoint;
...
public class StationListWidget extends AbstractWidget {
    public static final Component STATIONS_LABEL = Component.translatable("screen." + MediaPlayer.MOD_ID + ".globe.stations");
    public static final Component EMPTY_STATIONS_LABEL = Component.translatable("screen." + MediaPlayer.MOD_ID + ".globe.stations.empty");
    public static final Component SEARCH_LABEL = Component.translatable("screen." + MediaPlayer.MOD_ID + ".globe.stations.search");

...
import dev.turtywurty.mediaplayer.client.GlobePointCache;
import dev.turtywurty.mediaplayer.client.RadioStationPoint;
import dev.turtywurty.mediaplayer.client.gui.widget.GlobeWidget;
import dev.turtywurty.mediaplayer.client.gui.widget.StationListWidget;
...
public class GlobeScreen extends Screen {
    public static final Component TITLE = Component.translatable("screen." + MediaPlayer.MOD_ID + ".globe.title");

...
public class RadioPlayerScreen extends Screen {
    public static final Component TITLE = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player");
    public static final Component URL_LABEL = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.url");
    public static final Component NICKNAME_LABEL = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.nickname");
    public static final Component STATIONS_LABEL = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.stations");
    public static final Component EMPTY_STATIONS_LABEL = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.stations.empty");
    public static final Component APPLY_URL_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.url.apply");
    public static final Component ADD_STATION_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.station.add");
    public static final Component EDIT_STATION_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.station.edit");
    public static final Component REMOVE_STATION_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.station.remove");
    public static final Component PLAY_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.play");
    public static final Component STOP_BUTTON = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.stop");
    public static final Component INVALID_URL_TITLE = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.invalid_url");
    public static final Component INVALID_URL_DESCRIPTION = Component.translatable("screen." + MediaBox.MOD_ID + ".radio_player.invalid_url.description");
    private static final Identifier CHECKMARK_SPRITE = Identifier.withDefaultNamespace("icon/checkmark");
    private static final Identifier EDIT_SPRITE = MediaBox.id("radio/pencil");
    private static final Identifier DELETE_SPRITE = MediaBox.id("radio/delete");
    private static final Identifier RESUME_SPRITE = MediaBox.id("radio/resume");
    private static final Identifier STOP_SPRITE = MediaBox.id("radio/stop");
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                Minecraft.getInstance().execute(() -> {
                    ...
                    if (throwable != null) {
                        MediaBox.LOGGER.warn("Radio URL validation failed for {}", station, throwable);
                        showInvalidUrlToast();
                        updateActionButtons();
                        return;
                    }

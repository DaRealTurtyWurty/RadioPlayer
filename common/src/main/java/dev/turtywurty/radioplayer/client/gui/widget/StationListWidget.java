package dev.turtywurty.radioplayer.client.gui.widget;

import dev.turtywurty.radioplayer.Radioplayer;
import dev.turtywurty.radioplayer.api.client.GlobePoint;
import dev.turtywurty.radioplayer.client.RadioStationPoint;
...
public class StationListWidget extends AbstractWidget {
    public static final Component STATIONS_LABEL = Component.translatable("screen." + Radioplayer.MOD_ID + ".globe.stations");
    public static final Component EMPTY_STATIONS_LABEL = Component.translatable("screen." + Radioplayer.MOD_ID + ".globe.stations.empty");
    public static final Component SEARCH_LABEL = Component.translatable("screen." + Radioplayer.MOD_ID + ".globe.stations.search");
